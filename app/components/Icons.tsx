...
export const Icons = {
  linkedin: (props: { size?: number; color?: string }) => (
    <Svg
      width={props.size || 24}
  ...
  github: (props: { size?: number; color?: string }) => (
    <Svg
      width={props.size || 24}
      height={props.size || 24}
      viewBox="0 0 24 24"
  ...
  email: (props: { size?: number; color?: string }) => (
    <Svg
      width={props.size || 24}
      height={props.size || 24}
      viewBox="0 0 24 24"
  ...
  school: (props: { size?: number; color?: string }) => (
    <svg
      width={props.size || 24}
      height={props.size || 24}
      viewBox="0 0 24 24"
  ...
  skills: (props: { size?: number; color?: string }) => (
    <svg
      width={props.size || 24}
      height={props.size || 24}
      viewBox="0 0 24 24"
      fill={props.color || "#fff"}
    >
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm2-14h-4v2h4v-2zm0 4h-4v2h4v-2zm0 4h-4v2h4v-2z" />
    </svg>
  ),
  projects: (props: { size?: number; color?: string }) => (
    <svg
      width={props.size || 24}
      height={props.size || 24}
      viewBox="0 0 24 24"
  ...
  "shopping-cart": (props: { size?: number; color?: string }) => (
    <Svg
      width={props.size || 24}
      height={props.size || 24}
      viewBox="0 0 24 24"
  ...
  "graduation-cap": (props: { size?: number; color?: string }) => (
    <Svg
      width={props.size || 24}
      height={props.size || 24}
      viewBox="0 0 24 24"
